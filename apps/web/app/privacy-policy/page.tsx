...
export const metadata = buildMetadata({
  title: "Privacy Policy · MyPerkFinder",
  description:
    "How MyPerkFinder collects, uses, and protects your information, including email preferences and analytics.",
  path: "/privacy-policy",
});

export default function PrivacyPolicyPage() {
  return (
    <LegalPage title="Privacy Policy" description="Last updated: July 18, 2026">
      <p>
